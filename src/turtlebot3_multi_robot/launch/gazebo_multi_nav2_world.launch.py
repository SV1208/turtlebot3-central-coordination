...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb1', 'x_pose': '3.0', 'y_pose': '0.1'},
        {'name': 'tb2', 'x_pose': '-1.1', 'y_pose': '2.8'},
...
# It works to keep the world as below
    world = os.path.join(
        get_package_share_directory('turtlebot3_multi_robot'),
        'worlds', 'tworld.world')
    ...
    map_server=Node(package='nav2_map_server',
        ...
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('turtlebot3_multi_robot'), 'maps', 'tmap.yaml'),
                     },],
